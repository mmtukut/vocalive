    ...
    return (
        <div className="relative h-screen w-full bg-black overflow-hidden flex flex-col">
            ...
            <div className="absolute top-0 left-0 right-0 z-20 safe-area-top">
                <div className="flex items-center justify-between px-6 sm:px-10 py-6 bg-gradient-to-b from-black/80 via-black/40 to-transparent">
                    <button
                        onClick={() => router.push('/')}
            ...
            <div className="absolute bottom-0 left-0 right-0 z-20 safe-area-bottom">
                <div className="px-6 sm:px-10 pb-12 pt-12 bg-gradient-to-t from-black/95 via-black/70 to-transparent">
